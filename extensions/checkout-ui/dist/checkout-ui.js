...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    (0, import_react11.useEffect)(() => {
      const removeStorage = () => __async(this, null, function* () {
        const data = yield storage.delete("variantId");
      });
      const getPreviousId = () => __async(this, null, function* () {
        const data = yield storage.read("variantId");
        console.log("data111", data);
        if (data && amount > 99) {
          addPreviousRemovedProduct(data);
        }
      });
      const storeDeletedId = (id) => __async(this, null, function* () {
        const data = yield storage.write("variantId", id);
      });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, {});
  }
})();
